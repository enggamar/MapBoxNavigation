...
package com.map_box.MapBoxDemo
...
class MainActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1IjoiYW1hcmt1bWFyIiwiYSI6ImNrYjZlcXlxMzB5dHkyeW82bDBwOTZoZncifQ.fgAhbCA3NnPTIZG8RCk_WA")
        ...
        btnModeChange.setOnClickListener {
    ...
    private fun updateCurrentNightMode(modeNightYes: Int) {
        AppCompatDelegate.setDefaultNightMode(modeNightYes);
        btnModeChange.apply {

            text = if (AppCompatDelegate.MODE_NIGHT_AUTO == AppCompatDelegate.getDefaultNightMode()) {
    ...
    override fun onMapClick(point: LatLng) {
        ...
        map.addMarker(MarkerOptions().setTitle("Destination Location").setSnippet("This is a snippet about this marker that will show up here").position(point))
